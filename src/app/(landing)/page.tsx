...
import { FlipWords } from "@/components/general/flip-words"
...
export default function Page() {
  ...
  const integrations = ["Google Sheets!", "Notion!", "Airtable!"]

  return (
    <>
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="text-center">
          <div className="relative mx-auto text-left flex flex-col items-center gap-10">
            <div>
              <Heading>
                <span>Create Forms, Deliver Responses,</span>
                <br />
                <span className="relative bg-clip-text">Directly to</span>
                {/* <br /> */}
                <FlipWords
                  duration={2000}
                  words={integrations}
