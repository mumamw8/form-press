...
const SelectNative = ({
  ...
  return (
    <div className={"form-theme-input-width relative flex"}>
      <select
        ...
        className={cn(
          ...
          transition-[color,box-shadow] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 w-full outline-none`,
          props.multiple
